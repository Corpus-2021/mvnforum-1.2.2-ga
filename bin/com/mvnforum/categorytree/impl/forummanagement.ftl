      ...
      <td align="center">
        <#if row.CanEditCat>
          <a href="${row.EditCatLink}">
            <img src="${row.ContextPath}/mvnplugin/mvnforum/images/icon/button_edit.gif" border="0" alt="Edit category:  ${row.CatName}" />
          </a>
        </#if>
      </td>
      <td align="center">
    ...
    <#if row.CanReadPost>
      ...
      <#if row.CanEditForum>
        <a href="${row.EditForumLink}">
          <img src="${row.ContextPath}/mvnplugin/mvnforum/images/icon/button_edit.gif" border="0" alt="Edit forum: ${row.ForumName}" />
        </a>
      </#if>
      </td>
      <td align="center">
