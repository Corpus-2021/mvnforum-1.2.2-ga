          ...
          <tr>
            ...
            <td valign="top" width="20">
              <#if row.enableEasyWatching>
                <#if row.isWatched>
                  <img src="${row.ContextPath}/mvnplugin/mvnforum/images/icon/button_watching.gif" border="0" alt="" title="${row.WatchingThisCategory}" />
                <#else>
                  <a href="${row.addWatchCategoryLink}">
                    <img src="${row.ContextPath}/mvnplugin/mvnforum/images/icon/button_watch.gif" border="0" alt="" title="${row.WatchThisCategory}" />
                  </a>
                </#if>
              </#if>
            </td>
