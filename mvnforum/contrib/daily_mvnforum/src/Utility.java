...
public class Utility {
     ...
     */
    public final static String replace(final String text, final String search, final String replace) {
     ...
     */
    public final static void waitln() {
     ...
     */
    public final static StringBuffer getSpaces(int length) {
