/*
 * $Header: /cvsroot/mvnforum/mvnforum/contrib/phpbb2mvnforum/src/org/mvnforum/phpbb2mvnforum/db/ForumBean.java,v 1.7 2008/06/17 04:49:39 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.7 $
 * $Date: 2008/06/17 04:49:39 $
 *
 * ====================================================================
 *
...
public class ForumBean {
    ...
    public void ensureNotDisabledForum(Locale locale) throws BadInputException {
        if (forumStatus == com.mvnforum.db.ForumBean.FORUM_STATUS_DISABLED) {
    ...
    public void ensureNotLockedForum(Locale locale) throws BadInputException {
        if (forumStatus == com.mvnforum.db.ForumBean.FORUM_STATUS_LOCKED) {
    ...
    public void ensureNotClosedForum(Locale locale) throws BadInputException {
        if (forumStatus == com.mvnforum.db.ForumBean.FORUM_STATUS_CLOSED) {
