<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/index_mvnforum.jsp,v 1.14.2.1 2010/08/17 04:58:58 minhnn Exp $
 - $Author: minhnn $
 - $Revision: 1.14.2.1 $
 - $Date: 2010/08/17 04:58:58 $
 -
 - ====================================================================
 -
...
<hr>
<a href="http://www.mvnforum.com"><img src="/mvnforum_portlet/mvnplugin/mvnforum/images/logo.gif" alt="" width="141" height="50" border="0"></a>
<a href="http://www.mvnforum.com"><img src="/mvnad_portlet/mvnplugin/mvnad/images/logo.gif" alt="" width="140" height="50" border="0"></a>
<p>
...
<% if (false /* mvnCMS */) {%>
<hr>
<b>MVN Collaboration Suite</b> includes <b>mvnCMS</b>, <b>mvnForum Enterprise</b> and <b>mvnAd Enterprise</b>
<p>
<a href="http://www.mvncms.com"><img src="/mvncms/mvnplugin/mvncms/images/logo.gif" alt="" width="140" height="50" border="0"></a>
...
<p>
<p>
For mvnCMS Index page, click <a href="/mvncms/cms/">mvnCMS Index page</a>
<p>
For mvnCMS Config Layout page, click <a href="/mvncms/cms/confighome">mvnCMS Config Layout page</a>
<p>
For mvnCMS Admin page, click <a href="/mvncms/Home.thtml">mvnCMS Admin page</a>
<p>
Please use username <font color="#FF0000">admin</font> and password <font color="#FF0000">admin</font>
<% } %>
