<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/editgroupforumpermission.jsp,v 1.77 2008/06/13 09:23:17 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.77 $
...
<form action="<%=urlResolver.encodeURL(request, response, "updategroupforumpermission", URLResolverService.ACTION_URL)%>" method="post" name="submitform">
