<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/editgroupowner.jsp,v 1.74 2008/06/13 09:23:17 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.74 $
...
--%>  
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.common.group.group_owner_name"/>:</td>
    <td><input type="text" name="GroupOwnerName" value="<%if (groupOwner != 0) {%><%=groupBean.getGroupOwnerName()%><%}%>" maxlength="30" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
