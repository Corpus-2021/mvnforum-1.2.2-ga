<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/resetavatarsuccess.jsp,v 1.39 2008/06/13 09:23:18 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.39 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.admin.resetavatarsuccess.title"/></mvn:title>
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.admin.resetavatarsuccess.title"/>
    </td>
  </tr>
</table>
<br/>
