<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/sendactivatemailtoallsuccess.jsp,v 1.34 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.34 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.admin.sendactivatemailtoallsuccess.title"/></mvn:title>
...
<%
Collection mailMessageStructs = (Collection)request.getAttribute("MailMessageStructs");
%>
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.admin.sendactivatemailtoallsuccess.title"/> (<fmt:message key="mvnforum.admin.sendmailsuccess.number_sent"/>: <font color="#FF0000"><%=mailMessageStructs.size()%></font>)
    </td>
  </tr>
</table>
<br/>
