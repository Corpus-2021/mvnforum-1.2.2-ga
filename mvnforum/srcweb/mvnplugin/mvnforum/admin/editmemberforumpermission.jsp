<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/editmemberforumpermission.jsp,v 1.75 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.75 $
...
<br/>
<form action="<%=urlResolver.encodeURL(request, response, "updatememberforumpermission", URLResolverService.ACTION_URL)%>" method="post" name="submitform">
