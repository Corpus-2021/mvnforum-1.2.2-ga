<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/resetsignaturesuccess.jsp,v 1.39 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.39 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.admin.resetsignaturesuccess.title"/></mvn:title>
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.admin.resetsignaturesuccess.title"/>
    </td>
  </tr>
</table>
<br/>
