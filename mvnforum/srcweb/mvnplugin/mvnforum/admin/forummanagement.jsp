<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/forummanagement.jsp,v 1.94 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.94 $
...
<%if (permission.canEditCategory()) {%>
    <a href="<%=urlResolver.encodeURL(request, response, "editcategory?category=" + categoryBean.getCategoryID())%>"><img src="<%=contextPath%>/mvnplugin/mvnforum/images/icon/button_edit.gif" border="0" alt="Edit category: <%=categoryBean.getCategoryName()%>" /></a>
<%}%>
    </td>
    <td align="center">
...
%>
  ...
  <%if ( permission.canEditForum(forumBean.getForumID()) ) {%>
      <a href="<%=urlResolver.encodeURL(request, response, "editforum?forum=" + forumBean.getForumID())%>"><img src="<%=contextPath%>/mvnplugin/mvnforum/images/icon/button_edit.gif" border="0" alt="Edit forum: <%=forumBean.getForumName()%>" /></a>
  <%}%>
    </td>
    <td align="center">
