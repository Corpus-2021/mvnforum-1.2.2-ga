<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/listpendinguserssuccess.jsp,v 1.27 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.27 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.admin.listpendinguserssuccess.title"/></mvn:title>
<%@ include file="/mvnplugin/mvnforum/meta.jsp"%>
<meta http-equiv="refresh" content="3; url=<%=urlResolver.encodeURL(request, response, "listpendingusers")%>" />
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <a class="nav" href="<%=urlResolver.encodeURL(request, response, "listpendingusers")%>"><fmt:message key="mvnforum.admin.listpendingusers.title"/></a>&nbsp;&raquo;&nbsp;
    <fmt:message key="mvnforum.admin.listpendinguserssuccess.title"/>
    </td>
  </tr>
</table>
<br/>
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr class="<mvn:cssrow/>">
    <td><b>&raquo;&nbsp;</b><a class="command" href="<%=urlResolver.encodeURL(request, response, "listpendingusers?offset=" + request.getParameter("Offset"))%>"><fmt:message key="mvnforum.admin.success.return_to_listpending_user"/></a> (<fmt:message key="mvnforum.common.success.automatic"/>)</td>
  </tr>
  <tr class="<mvn:cssrow/>">
