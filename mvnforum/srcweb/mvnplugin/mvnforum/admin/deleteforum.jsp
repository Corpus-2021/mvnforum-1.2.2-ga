<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/deleteforum.jsp,v 1.93 2008/06/13 09:23:17 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.93 $
...
<table width="95%" align="center">
  <tr class="nav">
    <td><img
      src="<%=contextPath%>/mvnplugin/mvnforum/images/nav.gif" alt="" /></td>
