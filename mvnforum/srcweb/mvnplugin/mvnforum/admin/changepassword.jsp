<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/changepassword.jsp,v 1.54 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.54 $
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.common.member.new_password"/></td>
    <td><input type="password" name="MemberMatkhau" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.common.member.new_password"/> (<fmt:message key="mvnforum.common.retype"/>)</td>
