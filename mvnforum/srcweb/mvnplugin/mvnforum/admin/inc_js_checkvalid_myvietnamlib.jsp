<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/inc_js_checkvalid_myvietnamlib.jsp,v 1.17 2007/12/18 04:58:45 minhnn Exp $
 - $Author: minhnn $
 - $Revision: 1.17 $
 ...
 - @author: Mai  Nguyen  
 --%>
<script type="text/javascript" language="JavaScript" src="<%=contextPath%>/mvnplugin/mvnforum/js/myvietnam.js"></script>
