<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/deletenonactivatedmembers.jsp,v 1.58 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.58 $
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr class="<mvn:cssrow/>">
    ...
    <td><input type="checkbox" name="deletesentmessages" class="noborder" value="yes" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
