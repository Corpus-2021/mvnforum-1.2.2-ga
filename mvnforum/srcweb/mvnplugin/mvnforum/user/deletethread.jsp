<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/deletethread.jsp,v 1.76 2008/06/23 03:55:10 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.76 $
 - $Date: 2008/06/23 03:55:10 $
 -
 - ====================================================================
 -
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.user.deletethread.title"/>: <%=threadBean.getThreadTopic()%>
    --%>
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  <tr class="pagedesc">
    <td class="warning"><fmt:message key="mvnforum.user.deletethread.guide"/></td>
  </tr>
</table>
<br/>
