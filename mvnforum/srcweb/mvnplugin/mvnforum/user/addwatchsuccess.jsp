<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/addwatchsuccess.jsp,v 1.35 2008/06/13 09:23:21 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.35 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.user.addwatchsuccess.title"/></mvn:title>
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.user.addwatchsuccess.title"/>
    </td>
  </tr>
</table>
<br/>
