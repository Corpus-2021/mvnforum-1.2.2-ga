<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/movethread.jsp,v 1.61 2008/06/13 09:23:24 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.61 $
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.user.movethread.title"/>: <%=threadBean.getThreadTopic()%>
    --%>
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  <tr class="pagedesc">
    <td class="warning"><fmt:message key="mvnforum.user.movethread.guide"/></td>
  </tr>
</table>
<br/>
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.user.movethread.destinationforum"/></td>
    <td>
<%--
