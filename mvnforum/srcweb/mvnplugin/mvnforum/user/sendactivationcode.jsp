<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/sendactivationcode.jsp,v 1.59 2008/06/13 09:23:21 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.59 $
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    ...
    <td><input type="text" name="MemberName" value="<%=ParamUtil.getParameterFilter(request, "member")%>" size="30"/></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.common.member.email"/></td>
    <td><input type="text" name="MemberEmail" value="<%=ParamUtil.getParameterFilter(request, "email")%>" size="30"/></td>
  </tr>
