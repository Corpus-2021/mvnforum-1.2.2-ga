<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/activatemember.jsp,v 1.49 2008/06/13 09:23:21 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.49 $
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td width="20%"><fmt:message key="mvnforum.user.activatemember.member_id"/></td>
    <td><input type="text" name="member" value="<%=ParamUtil.getParameterFilter(request, "member")%>" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.user.activatemember.activation_code"/></td>
    <td><input type="text" name="activatecode" value="<%=ParamUtil.getParameterFilter(request, "activatecode")%>" /></td>
  </tr>
  <tr>
