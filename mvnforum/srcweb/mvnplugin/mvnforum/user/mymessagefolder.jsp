<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/mymessagefolder.jsp,v 1.38 2008/06/16 09:27:43 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.38 $
 - $Date: 2008/06/16 09:27:43 $
 -
 - ====================================================================
 -
...
%>
  <tr class="<mvn:cssrow/>">
    <td align="left">
      ...
      <a href="<%=urlResolver.encodeURL(request, response, "mymessage?folder=" + folderName)%>"><%=folderName%></a>
    </td>
    <td align="center">
      <table width="100%" class="noborder">
        <tr class="<mvn:cssrow autoIncrease="false"/>">
          <td width="30%" align="center">
            ...
            <a href="<%=urlResolver.encodeURL(request, response, "updatefolderorder?folder=" + folderName + "&amp;action=up")%>"><img src="<%=contextPath%>/mvnplugin/mvnforum/images/icon/up.gif" border="0" alt="<fmt:message key="mvnforum.common.order.move_up"/>" title="<fmt:message key="mvnforum.common.order.move_up"/>"/></a>
            <% } %>
          </td>
          <td width="40%" align="center"><b><%=messageFolderBean.getFolderOrder()%></b></td>
          <td width="30%" align="center"><a href="<%=urlResolver.encodeURL(request, response, "updatefolderorder?folder=" + folderName + "&amp;action=down")%>"><img src="<%=contextPath%>/mvnplugin/mvnforum/images/icon/down.gif" border="0" alt="<fmt:message key="mvnforum.common.order.move_down"/>" title="<fmt:message key="mvnforum.common.order.move_down"/>"/></a></td>
        </tr>
      </table>
    </td>
