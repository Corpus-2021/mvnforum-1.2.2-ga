<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/myfavoritethread.jsp,v 1.85 2008/06/13 09:23:21 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.85 $
...
%>
  <tr class="<mvn:cssrow/>">
    ...
    <td align="center"><a href="<%=urlResolver.encodeURL(request, response, "deletefavoritethreadprocess?thread=" + threadBean.getThreadID(), URLResolverService.ACTION_URL)%>" class="command"><fmt:message key="mvnforum.common.action.delete"/></a></td>
  </tr>
<%
}//for
