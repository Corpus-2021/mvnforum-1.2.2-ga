<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/listthreadswithpendingposts.jsp,v 1.65 2008/06/13 09:23:23 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.65 $
 - $Date: 2008/06/13 09:23:23 $
 -
 - ====================================================================
 -
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.common.forum"/>: <a class="nav" href="<%=urlResolver.encodeURL(request, response, "listthreads?forum=" + forumID)%>"><%=forumCache.getBean(forumID).getForumName()%></a>&nbsp;&raquo;&nbsp;
