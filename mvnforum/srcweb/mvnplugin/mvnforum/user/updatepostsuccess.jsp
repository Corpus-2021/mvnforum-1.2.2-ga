<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/updatepostsuccess.jsp,v 1.61 2008/06/13 09:23:21 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.61 $
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.user.updatepostsuccess.title"/>
     --%>
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  <tr class="pagedesc">
    <td><fmt:message key="mvnforum.user.updatepostsuccess.moderation_waiting"/></td>
  </tr>
</table>
<br/>
<% } %>
