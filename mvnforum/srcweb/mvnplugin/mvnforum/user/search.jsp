<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/search.jsp,v 1.100 2008/06/13 09:23:22 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.100 $
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <a class="nav" href="<%=urlResolver.encodeURL(request, response, "search")%>"><fmt:message key="mvnforum.user.search.title"/></a>&nbsp;&raquo;&nbsp;
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.user.search.search_text"/></td>
    <td><input type="text" name="key" value="<%=key%>" size="60" onkeyup="initTyper(this);" onkeydown="if (event.keyCode==13) SubmitForm();"/></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.user.search.by_member"/></td>
    <td><input type="text" name="member" value="<%=member%>" size="60"/></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.user.search.scope_in_post"/></td>
    <td>
      <select name="scopeinpost" class="noborder">
...
%>      
  ...
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.common.sort_by"/></td>
    <td>
      <select name="sort">
