<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/deleteattachment.jsp,v 1.67 2008/06/13 09:23:25 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.67 $
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.user.deleteattachment.title"/>: <%=attachmentBean.getAttachFilename()%>
    --%>
