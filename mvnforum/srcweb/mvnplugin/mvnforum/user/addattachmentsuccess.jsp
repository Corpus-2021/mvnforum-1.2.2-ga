<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/addattachmentsuccess.jsp,v 1.42 2008/06/13 09:23:21 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.42 $
...
String offset   = ParamUtil.getAttribute(request, "offset");

//boolean attachMore = ((Boolean)request.getAttribute("AttachMore")).booleanValue();
//we set attachMore = false for our project
...
<% if (attachMore) { %>
  <tr class="<mvn:cssrow/>">
    <td><b>&raquo;&nbsp;</b><a class="command" href="<%=urlResolver.encodeURL(request, response, attachLink)%>"><fmt:message key="mvnforum.user.success.go_attach_file"/></a> (<fmt:message key="mvnforum.common.success.automatic"/>)</td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><b>&raquo;&nbsp;</b><a class="command" href="<%=urlResolver.encodeURL(request, response, viewthreadLink)%>"><fmt:message key="mvnforum.user.success.go_current_post"/></a></td>
  </tr>
<% } else { %>
  <tr class="<mvn:cssrow/>">
    <td><b>&raquo;&nbsp;</b><a class="command" href="<%=urlResolver.encodeURL(request, response, viewthreadLink)%>"><fmt:message key="mvnforum.user.success.go_current_post"/></a> (<fmt:message key="mvnforum.common.success.automatic"/>)</td>
  </tr>
<% } %>
  <tr class="<mvn:cssrow/>">
