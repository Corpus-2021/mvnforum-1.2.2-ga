  ...
  <tr>
    ...
    <%=urlResolver.generateFormAction(request, response, "loginprocess")%>
      <td>
        ...
        <input type="text" name="MemberName" value="<%=ParamUtil.getAttribute(request, "MemberName")%>" size="10" />
        <fmt:message key="mvnforum.common.member.password"/>
        <input type="password" name="MemberMatkhau" onkeypress="checkEnterLogin(event);" size="10" />
