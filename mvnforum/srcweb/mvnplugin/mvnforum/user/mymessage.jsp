<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/mymessage.jsp,v 1.100 2008/06/16 09:27:42 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.100 $
 - $Date: 2008/06/16 09:27:42 $
 -
 - ====================================================================
 -
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <td width="100%" nowrap="nowrap">
      ...
      <fmt:message key="mvnforum.user.mymessage.title"/> (<fmt:message key="mvnforum.common.private_message.folder"/>: <%=folder%>)
    </td>
  </tr>
</table>
<br/>
