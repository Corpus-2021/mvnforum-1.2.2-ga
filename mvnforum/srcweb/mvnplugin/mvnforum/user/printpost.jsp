<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/printpost.jsp,v 1.49 2008/06/13 09:23:21 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.49 $
...
<table width="98%" align="center">
  <tr class="nav">
    ...
    &raquo;&nbsp;&raquo;&nbsp;&raquo;&nbsp;
    <fmt:message key="mvnforum.common.thread"/>: <a class="nav" href="<%=urlResolver.encodeURL(request, response, "viewthread?thread=" + threadID)%>"><%=MyUtil.filter(threadBean.getThreadTopic(), false/*html*/, true/*emotion*/, false/*mvnCode*/, false/*newLine*/, false/*URL*/)%></a><br/>
    &raquo;&nbsp;&raquo;&nbsp;&raquo;&nbsp;&raquo;&nbsp;
    <fmt:message key="mvnforum.common.post"/>: <a class="nav" href="<%=urlResolver.encodeURL(request, response, "viewthread?thread=" + threadID + "#" + postBean.getPostID())%>"><%=MyUtil.filter(postBean.getPostTopic(), false/*html*/, true/*emotion*/, false/*mvnCode*/, false/*newLine*/, false/*URL*/)%></a>
    </td>
  </tr>
  <tr class="portlet-font">
    <td><br/><fmt:message key="mvnforum.user.printthread.print_at"/> <b><%=onlineUser.getGMTTimestampFormat(DateUtil.getCurrentGMTTimestamp())%></b></td>
  </tr>
</table>
<br/>
