<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/editwatchsuccess.jsp,v 1.19 2008/06/13 09:23:20 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.19 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.user.editwatchsuccess.title"/></mvn:title>
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.user.editwatchsuccess.title"/>
    </td>
  </tr>
</table>
<br/>
