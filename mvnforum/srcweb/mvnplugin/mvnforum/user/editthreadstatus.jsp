<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/editthreadstatus.jsp,v 1.49 2008/06/13 09:23:22 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.49 $
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.user.editthreadstatus.title"/>: <%=threadBean.getThreadTopic()%>
    --%>
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.common.thread.status"/></td>
    <td>
      <select name="ThreadStatus" size="1">
      <%for (int i = 0; i < 4; i++) {
