/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/common/DeleteOrphanPmAttachmentTask.java,v 1.5 2008/06/01 17:22:06 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.5 $
...
public final class DeleteOrphanPmAttachmentTask extends TimerTask {
    ...
    // static variable
    private static final Log log = LogFactory.getLog(DeleteOrphanPmAttachmentTask.class);
    ...
    public void run() {
        ...
        try {
            ...
            log.debug("DeleteOrphanPmAttachmentTask:deleteOrphanPmAttachment process " + count + " times, took " + duration + " ms");
        }
    }
}
