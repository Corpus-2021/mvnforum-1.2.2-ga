/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/common/WatchSendTask.java,v 1.7 2008/06/01 17:22:06 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.7 $
...
public final class WatchSendTask extends TimerTaskAbstract {
    ...
    // static variable
    private static final Log log = LogFactory.getLog(WatchSendTask.class);
