/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/common/ReloadTomcatTimerTaskExt.java,v 1.7 2008/06/01 17:22:06 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.7 $
...
public final class ReloadTomcatTimerTaskExt extends TimerTaskAbstract implements TimerTaskExt {
    ...
    // static variable
    private static final Log log = LogFactory.getLog(ReloadTomcatTimerTaskExt.class);
