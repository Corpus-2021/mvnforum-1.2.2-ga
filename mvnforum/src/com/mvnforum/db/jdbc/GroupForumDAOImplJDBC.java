/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/db/jdbc/GroupForumDAOImplJDBC.java,v 1.13 2008/05/30 04:41:30 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.13 $
...
public class GroupForumDAOImplJDBC implements GroupForumDAO {
    ...
    private static final Log log = LogFactory.getLog(GroupForumDAOImplJDBC.class);
