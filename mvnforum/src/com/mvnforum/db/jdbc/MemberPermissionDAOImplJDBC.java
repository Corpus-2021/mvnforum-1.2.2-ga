/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/db/jdbc/MemberPermissionDAOImplJDBC.java,v 1.12 2008/05/30 04:41:32 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.12 $
 * $Date: 2008/05/30 04:41:32 $
 *
 * ====================================================================
 *
...
public class MemberPermissionDAOImplJDBC implements MemberPermissionDAO {
    ...
    private static final Log log = LogFactory.getLog(MemberPermissionDAOImplJDBC.class);
