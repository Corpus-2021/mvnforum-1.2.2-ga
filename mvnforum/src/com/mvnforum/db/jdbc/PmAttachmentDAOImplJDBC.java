/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/db/jdbc/PmAttachmentDAOImplJDBC.java,v 1.23 2008/05/30 04:41:33 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.23 $
...
public class PmAttachmentDAOImplJDBC implements PmAttachmentDAO {
    ...
    private static final Log log = LogFactory.getLog(PmAttachmentDAOImplJDBC.class);
