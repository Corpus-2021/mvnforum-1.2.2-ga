/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/db/PollBean.java,v 1.10 2007/12/10 03:21:11 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.10 $
 * $Date: 2007/12/10 03:21:11 $
 *
 * ====================================================================
 *
...
public class PollBean {
    ...
    public final static int POLL_VOTE_NO_CHANGE                  = 0;
    public final static int POLL_VOTE_CHANGE                     = 1;

    public final static int POLL_MULTIPLE_NO                     = 0;
    public final static int POLL_MULTIPLE_YES                    = 1;

    public final static int POLL_SHOW_RESULT_TO_ANYONE           = 0;
    public final static int POLL_SHOW_RESULT_AFTER_VOTED         = 1;
    public final static int POLL_SHOW_RESULT_AFTER_EXPIRED       = 2;

    public final static int POLL_NO_PUBLIC                       = 0;
    public final static int POLL_PUBLIC                          = 1;

    public final static int POLL_STATUS_EDITING                  = 0;
    public final static int POLL_STATUS_ENABLE                   = 1;
    public final static int POLL_STATUS_DISABLED                 = 2;

    public final static int POLL_TYPE_NORMAL                     = 0;
    public final static int POLL_TYPE_ANONYMOUS                  = 1;
    
    public final static int ORPHAN                               = 0;
    public final static int THREAD                               = 1;
    public final static int ALBUMITEM                            = 2;
