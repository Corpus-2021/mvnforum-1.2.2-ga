/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/db/common/MemberDAOExternalUserDatabaseAbstract.java,v 1.21 2008/05/30 04:41:29 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.21 $
...
public class MemberDAOExternalUserDatabaseAbstract implements MemberDAO {
    ...
    private static final Log log = LogFactory.getLog(MemberDAOExternalUserDatabaseAbstract.class);
