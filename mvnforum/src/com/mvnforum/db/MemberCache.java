/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/db/MemberCache.java,v 1.19 2008/06/24 18:36:28 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.19 $
 * $Date: 2008/06/24 18:36:28 $
 *
 * ====================================================================
 *
...
public class MemberCache {
    ...
    public Collection getPermissionsForGroupGuest()
        ...
        if (cache != null) {
            ...
            permList = (ArrayList)cache.retrieve(key);
            if (permList == null) {
