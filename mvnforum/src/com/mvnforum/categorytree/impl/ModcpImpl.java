/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/categorytree/impl/ModcpImpl.java,v 1.16 2008/05/30 04:41:25 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.16 $
 * $Date: 2008/05/30 04:41:25 $
 *
 * ====================================================================
 *
...
public class ModcpImpl extends FtlCategoryTreeListener {
    ...
    private static final Log log = LogFactory.getLog(ModcpImpl.class);
    ...
    public String drawCategory(CategoryTreeEvent event) {
        ...
        if (MyUtil.canViewAnyForumInCategory(categoryBean.getCategoryID(), permission) == false)
            return "";
