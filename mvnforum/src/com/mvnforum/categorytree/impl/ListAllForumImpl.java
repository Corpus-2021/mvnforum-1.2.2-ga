/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/categorytree/impl/ListAllForumImpl.java,v 1.14 2008/06/02 10:18:10 phuongpdd Exp $
 * $Author: phuongpdd $
 * $Revision: 1.14 $
 * $Date: 2008/06/02 10:18:10 $
 *
 * ====================================================================
 *
...
public class ListAllForumImpl extends FtlCategoryTreeListener {
    ...
    private static final Log log = LogFactory.getLog(ListAllForumImpl.class);
