/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/categorytree/impl/ListForums.java,v 1.35 2008/06/01 17:22:06 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.35 $
...
public class ListForums extends FtlCategoryTreeListener {
    ...
    private static final Log log = LogFactory.getLog(ListForums.class);
