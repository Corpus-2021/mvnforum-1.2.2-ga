/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/categorytree/impl/CategoryTreePath.java,v 1.16 2008/06/04 10:57:01 phuongpdd Exp $
 * $Author: phuongpdd $
 * $Revision: 1.16 $
 * $Date: 2008/06/04 10:57:01 $
 *
 * ====================================================================
 *
...
public class CategoryTreePath extends FtlCategoryTreeListener {
    ...
    private static final Log log = LogFactory.getLog(CategoryTreePath.class);

    public final static int FORUMID_IN_LIST_CATEGORY_CASE = 0;
