/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/categorytree/impl/CategorySelector.java,v 1.29 2008/05/30 18:08:38 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.29 $
...
public class CategorySelector extends FtlCategoryTreeListener  {
    ...
    private static final Log log = LogFactory.getLog(CategorySelector.class);
    ...
    public String drawCategory(CategoryTreeEvent event) {
        ...
        if (!checkAddCategory) {
            ...
            boolean noForum_Condition = ((page != null) && (MyUtil.canViewAnyForumInCategory(bean.getCategoryID(), permission) == false));
