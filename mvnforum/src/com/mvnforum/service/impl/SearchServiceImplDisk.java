/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/service/impl/SearchServiceImplDisk.java,v 1.18.2.2 2009/09/30 09:49:20 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.18.2.2 $
 * $Date: 2009/09/30 09:49:20 $
 *
 * ====================================================================
 *
...
public class SearchServiceImplDisk implements SearchService {
    ...
    private static final Log log = LogFactory.getLog(SearchServiceImplDisk.class);
    ...
    public Directory getSearchPostIndexDir() throws IOException {
        return FSDirectory.getDirectory(MVNForumConfig.getSearchPostIndexDirName());
    }

    public Directory getSearchMemberIndexDir() throws IOException {
        return FSDirectory.getDirectory(MVNForumConfig.getSearchMemberIndexDirName());
    }

    public Directory getSearchAttachmentIndexDir() throws IOException {
        return FSDirectory.getDirectory(MVNForumConfig.getSearchAttachmentIndexDirName());
    }

    public Directory getSearchAlbumItemIndexDir() throws IOException {
        return FSDirectory.getDirectory(MVNForumConfig.getSearchAlbumItemIndexDirName());
    }
