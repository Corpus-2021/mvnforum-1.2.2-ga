/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/auth/MVNForumPermissionWebHelper.java,v 1.13.2.3 2008/11/20 02:53:42 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.13.2.3 $
 * $Date: 2008/11/20 02:53:42 $
 *
 * ====================================================================
 *
...
public final class MVNForumPermissionWebHelper {
    ...
    private static final Log log = LogFactory.getLog(MVNForumPermissionWebHelper.class);
    ...
    static Collection getGroupPermissionsInForums(int memberID)
        ...
        if ((memberID!=0) && (memberID!=MVNForumConstant.MEMBER_ID_OF_GUEST)) {
            sql.append(" OR grpforum.GroupID = ").append(MVNForumConstant.GROUP_ID_OF_REGISTERED_MEMBERS);
        }
