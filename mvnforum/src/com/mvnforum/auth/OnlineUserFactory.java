/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/auth/OnlineUserFactory.java,v 1.14 2007/10/09 11:09:12 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.14 $
...
public interface OnlineUserFactory {
    ...
    /**
     * Authenticate the user given its login and password (maybe in
     ...
     *
     * @param request useful to retrieve additional information to
     * authenticate the user.
     * @param response a <code>HttpServletResponse</code> value
     * @param loginName a <code>String</code> value
     * @param password a <code>String</code> value
     * @param isEncodedPassword indicate if the password to validate is
     * already encoded. Note that some backends may not support to
     * validate against an encrypted password.
     * @return an <code>OnlineUser</code> value
     * @exception AuthenticationException if the pair login, password
     * is not valid. Note that this method will call the
     * {@link #validatePassword(String, String, boolean)}
    ...
    /**
     * Validate if the given login password pair is valid, in that
     * case <code>true</code> will be returned. If the password is not
     * correct, <code>false</code> will be returned. If the user does
    ...
    /**
     * Ensure the login/password pair is correct.
    ...
    /**
     * Get an encoded version of the user password. This can be
     ...
     * @param loginName a <code>String</code> value
     * @param password a <code>String</code> value
     * @return the encoded password of the user or <code>null</code>
     * if the backend does not support returning stored passwords.
     */
    public String getEncodedPassword(String loginName, String password);

    /**
     * Get the anonymous user of the system. The request is used to
