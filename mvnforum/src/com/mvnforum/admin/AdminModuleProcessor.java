/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/admin/AdminModuleProcessor.java,v 1.142 2008/06/03 11:15:45 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.142 $
 * $Date: 2008/06/03 11:15:45 $
 *
 * ====================================================================
 *
...
public class AdminModuleProcessor implements ModuleProcessor {
    ...
    private static final Log log = LogFactory.getLog(AdminModuleProcessor.class);
    
    private static int count;

    protected final String ORIGINAL_REQUEST = "mvnforum.admin.OriginalRequest";
...
//    }
     ...
     *         already committed (for example, if we sent (downloaded) a file to the user.
     */
...
//          @todo could throw Exception, so onlineUser will be null, caused NPE later
            ...
            if (requestURI.equals("/forummanagement")) {
                ...
                String localizedMessage = MVNForumResourceBundle.getString(locale, "java.lang.IllegalStateException.importexport_is_disabled");
                ...
                Locale locale = I18nUtil.getLocaleInRequest(genericRequest);
                String localizedMessage = MVNForumResourceBundle.getString(locale, "java.lang.IllegalStateException.list_user_expire_is_disabled");
                throw new IllegalStateException(localizedMessage);
...
//                }
        ...
        try {
            ...
            Action action = new ActionInAdminModule(genericRequest, requestURI);// may throw MissingURLMapEntryException
