/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/admin/AdminModuleURLMapHandler.java,v 1.99 2008/04/14 08:41:09 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.99 $
 * $Date: 2008/04/14 08:41:09 $
 *
 * ====================================================================
 *
...
public class AdminModuleURLMapHandler {
    ...
    public URLMap getMap(String requestURI, GenericRequest request)
        ...
        }  if (requestURI.equals("/viewlogsystem")) {
