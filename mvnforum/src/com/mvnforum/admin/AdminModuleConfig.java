/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/admin/AdminModuleConfig.java,v 1.15 2008/05/30 04:41:13 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.15 $
...
public final class AdminModuleConfig {
    ...
    private static final Log log = LogFactory.getLog(AdminModuleConfig.class);
    ...
    private static String URL_PATTERN = "/mvnforumadmin";
    ...
    static {
        try {
            ...
            URL_PATTERN = conf.getString("adminmoduleconfig.url_pattern", URL_PATTERN);
        } catch (Exception e) {
            String message = "com.mvnforum.admin.AdminModuleConfig: Can't read the configuration file: '" + OPTION_FILE_NAME +
