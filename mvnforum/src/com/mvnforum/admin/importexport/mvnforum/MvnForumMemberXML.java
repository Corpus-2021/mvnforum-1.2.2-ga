/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/admin/importexport/mvnforum/MvnForumMemberXML.java,v 1.9 2007/06/22 18:37:24 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.9 $
 * $Date: 2007/06/22 18:37:24 $
 *
 * ====================================================================
 *
...
/**
 * @author Igor Manic
 * @version $Revision: 1.9 $, $Date: 2007/06/22 18:37:24 $
 * <br/>
...
public class MvnForumMemberXML {
    ...
    public void addMember() 
         ...
         */
        if (!isAdmin) MvnForumXML.checkAdminMember();
        if ((!isAdmin) && (!isGuest)) MvnForumXML.checkGuestMember();
        ...
        memberXML.addMember(memberName, memberPassword, memberFirstEmail,
                            ...
                            memberCoolLink2);
        memberCreated=true;
        if (isAdmin) MvnForumXML.addedAdminMember=true;
        else if (isGuest) MvnForumXML.addedGuestMember=true;
    }

    public void addMemberPermission(String permission) throws CreateException,
