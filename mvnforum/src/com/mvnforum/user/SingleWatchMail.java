/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/user/SingleWatchMail.java,v 1.12.2.6 2008/11/28 08:59:30 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.12.2.6 $
 * $Date: 2008/11/28 08:59:30 $
 *
 * ====================================================================
 *
...
public class SingleWatchMail extends WatchMail {
    ...
    private static final Log log = LogFactory.getLog(SingleWatchMail.class);
    ...
    private void createWatchMessageBean(int threadID) throws ObjectNotFoundException, DatabaseException {
        ...
        ThreadBean thread = DAOFactory.getThreadDAO().getThread(threadID);
