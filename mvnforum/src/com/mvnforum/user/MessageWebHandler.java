/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/user/MessageWebHandler.java,v 1.106.2.2 2008/11/17 08:51:58 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.106.2.2 $
 * $Date: 2008/11/17 08:51:58 $
 *
 * ====================================================================
 *
...
public class MessageWebHandler {
    ...
    private static final Log log = LogFactory.getLog(MessageWebHandler.class);
    ...
    public void processAdd(GenericRequest request, GenericResponse response)
        ...
        try {
            FloodControl.ensureNotReachMaximum(MVNForumGlobal.FLOOD_ID_NEW_MESSAGE_PER_IP, currentIP);
            ...
            Integer maxMessages = new Integer(FloodControl.getActionsPerHour(MVNForumGlobal.FLOOD_ID_NEW_MESSAGE_PER_IP));
        ...
        FloodControl.increaseCount(MVNForumGlobal.FLOOD_ID_NEW_MESSAGE_PER_IP, currentIP);
    }
