/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/user/WatchMail.java,v 1.41.2.4 2008/11/18 11:07:46 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.41.2.4 $
 * $Date: 2008/11/18 11:07:46 $
 *
 * ====================================================================
 *
...
class WatchMail {
    ...
    // static variable
    private static final Log log = LogFactory.getLog(WatchMail.class);
