/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/user/PostUtil.java,v 1.26 2008/06/17 04:49:37 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.26 $
 * $Date: 2008/06/17 04:49:37 $
 *
 * ====================================================================
 *
...
public final class PostUtil {
    ...
    public static void addPost(int parentPostID, int forumID, int memberID, String currentIP, String memberName,
        ...
        CreateException, ForeignKeyNotFoundException {
