/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/search/member/MemberIndexer.java,v 1.25 2008/05/30 04:41:36 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.25 $
 * $Date: 2008/05/30 04:41:36 $
 *
 * ====================================================================
 *
...
public class MemberIndexer {
    ...
    private static final Log log = LogFactory.getLog(MemberIndexer.class);
    ...
    static void doIndexMember(MemberBean memberBean, IndexWriter writer) throws SearchException {
        ...
        memberDocument.add(new Field(FIELD_MEMBER_ID, Integer.toString(memberBean.getMemberID()), Field.Store.YES, Field.Index.UN_TOKENIZED));
        memberDocument.add(new Field(FIELD_MEMBER_NAME, memberBean.getMemberName(), Field.Store.NO, Field.Index.TOKENIZED));
        memberDocument.add(new Field(FIELD_MEMBER_EMAIL, memberBean.getMemberEmail(), Field.Store.NO, Field.Index.TOKENIZED));
        memberDocument.add(new Field(FIELD_MEMBER_LASTNAME, memberBean.getMemberLastname(), Field.Store.NO, Field.Index.TOKENIZED));
        memberDocument.add(new Field(FIELD_MEMBER_FIRSTNAME, memberBean.getMemberFirstname(), Field.Store.NO, Field.Index.TOKENIZED));
        memberDocument.add(new Field(FIELD_MEMBER_COUNTRY, memberBean.getMemberCountry(), Field.Store.NO, Field.Index.TOKENIZED));
        memberDocument.add(new Field(FIELD_CREATION_DATE, DateTools.dateToString(memberBean.getMemberCreationDate(), Resolution.MILLISECOND), Field.Store.YES, Field.Index.UN_TOKENIZED));
