/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/search/post/AddUpdatePostIndexTask.java,v 1.8 2008/05/30 04:41:36 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.8 $
...
public class AddUpdatePostIndexTask extends TimerTask {
    ...
    private static final Log log = LogFactory.getLog(AddUpdatePostIndexTask.class);
