/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/search/post/UpdateThreadIndexTask.java,v 1.2 2008/05/30 04:41:37 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.2 $
...
public class UpdateThreadIndexTask extends TimerTask {
    ...
    private static final Log log = LogFactory.getLog(UpdateThreadIndexTask.class);
    ...
    public void run() {
        ...
        try {
            ...
            log.info("UpdateThreadTask failed. Took " + (System.currentTimeMillis() - start) + " ms");
            return;
        }
