/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/search/post/PostIndexer.java,v 1.25 2008/06/01 17:22:07 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.25 $
...
public class PostIndexer {
    ...
    private static final Log log = LogFactory.getLog(PostIndexer.class);
    ...
    static void doIndexPost(PostBean post, IndexWriter writer) throws SearchException {
        ...
        postDocument.add(new Field(FIELD_WITH_ATTACHMENT, Boolean.valueOf(post.getPostAttachCount()>0).toString(), Field.Store.YES, Field.Index.UN_TOKENIZED));// make it compilable on JDK 1.3
