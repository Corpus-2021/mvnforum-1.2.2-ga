/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/search/post/DeletePostIndexTask.java,v 1.8 2008/05/30 04:41:36 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.8 $
...
public class DeletePostIndexTask extends TimerTask {
    ...
    private static final Log log = LogFactory.getLog(DeletePostIndexTask.class);
