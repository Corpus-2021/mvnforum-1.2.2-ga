...
-- $Header: /cvsroot/mvnforum/mvnforum/sql/mvnForum_DB2.sql,v 1.26 2007/10/12 10:59:14 minhnn Exp $
-- $Author: minhnn $
-- $Revision: 1.26 $
...
-- TIMESTAMP      : TIMESTAMP
-- VARCHAR        : VARCHAR
-- BLOB           : BLOB(n) where n <= 15,000,000
-- now()          : CURRENT DATE
-- now()          : CURRENT TIMESTAMP
--
-- NOTE: max length for index name is 18
...
-- Uncomment below line to create database and user
--
-- create db mvnforum using codeset UTF-8 territory US
-- connect to mvnforum user db2admin using db2admin
...
(
   ...
   CategoryDesc                   LONG VARCHAR                   NOT NULL,
...
CREATE INDEX GroupPerm_1_idx on mvnforumGroupPermission
(
   GroupID
);
...
(
   GroupID                        INT                            NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   GroupOwnerID                   INT                            NOT NULL,
   GroupOwnerName                 VARCHAR(30)                    NOT NULL,
   GroupName                      VARCHAR(250)                   NOT NULL,
   GroupDesc                      LONG VARCHAR                   NOT NULL,
...
(
   MemberID                       INT                            NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE INDEX MemberPerm_1_idx on mvnforumMemberPermission
(
   MemberID
);
...
CREATE INDEX MsgFolder_1_idx on mvnforumMessageFolder
(
   MemberID
);
...
(
   PostID                         INT                            NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
(
   ThreadID                       INT                            NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   ForumID                        INT                            NOT NULL,
   MemberName                     VARCHAR(30)                    NOT NULL,
   LastPostMemberName             VARCHAR(30)                    NOT NULL,
...
(
   WatchID                        INT                            NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   MemberID                       INT                            NOT NULL,
   CategoryID                     INT                            NOT NULL,
   ForumID                        INT                            NOT NULL,
   ThreadID                       INT                            NOT NULL,
...
CREATE INDEX Watch_CatID_idx on mvnforumWatch
(
   CategoryID
);
...
CREATE INDEX Att_PostID_idx on mvnforumAttachment
(
   PostID
);

CREATE INDEX Att_MemberID_idx on mvnforumAttachment
(
   MemberID
);
...
INSERT INTO mvnforumMessageFolder (FolderName, MemberID, FolderOrder, FolderStatus, FolderOption, FolderType, FolderCreationDate, FolderModifiedDate)
                           VALUES ('Inbox',    1,        0,           0,            0,            0,          CURRENT TIMESTAMP,  CURRENT TIMESTAMP);
INSERT INTO mvnforumMessageFolder (FolderName, MemberID, FolderOrder, FolderStatus, FolderOption, FolderType, FolderCreationDate, FolderModifiedDate)
                           VALUES ('Sent',     1,        2,           0,            0,            0,          CURRENT TIMESTAMP,  CURRENT TIMESTAMP);


--
-- data for table mvnforumGroups
--
INSERT INTO mvnforumGroups (GroupOwnerID, GroupOwnerName, GroupName, GroupDesc,                                                GroupOption, GroupCreationDate, GroupModifiedDate)
                    VALUES (0,            '',             'Guest',   'All anonymous users belong to this group.',              0,         CURRENT TIMESTAMP, CURRENT TIMESTAMP);
INSERT INTO mvnforumGroups (GroupOwnerID, GroupOwnerName, GroupName, GroupDesc,                                                GroupOption, GroupCreationDate, GroupModifiedDate)
                    VALUES (0,            '',             'Member',  'All registered users belong to this group.',             0,         CURRENT TIMESTAMP, CURRENT TIMESTAMP);
INSERT INTO mvnforumGroups (GroupOwnerID, GroupOwnerName, GroupName, GroupDesc,                                                GroupOption, GroupCreationDate, GroupModifiedDate)
                    VALUES (1,            'admin',        'Admin',   'This group have SystemAdmin permission by default.',     0,         CURRENT TIMESTAMP, CURRENT TIMESTAMP);
INSERT INTO mvnforumGroups (GroupOwnerID, GroupOwnerName, GroupName, GroupDesc,                                                GroupOption, GroupCreationDate, GroupModifiedDate)
                    VALUES (1,            'admin',        'Forum Admin', 'This group have ForumAdmin permission by default.',  0,         CURRENT TIMESTAMP, CURRENT TIMESTAMP);
INSERT INTO mvnforumGroups (GroupOwnerID, GroupOwnerName, GroupName, GroupDesc,                                                GroupOption, GroupCreationDate, GroupModifiedDate)
                    VALUES (1,            'admin',        'Forum Moderator', 'This group have ForumModerator permission by default.',0,   CURRENT TIMESTAMP, CURRENT TIMESTAMP);
...
INSERT INTO mvnforumMemberGroup (GroupID, MemberID, MemberName, Privilege, CreationDate,    ModifiedDate)
                         VALUES (3,       1,       'admin',     0,       CURRENT TIMESTAMP, CURRENT TIMESTAMP);
