...
-- $Header: /cvsroot/mvnforum/mvnforum/sql/mvnForum_postgresql.sql,v 1.28 2007/10/12 10:59:14 minhnn Exp $
-- $Author: minhnn $
-- $Revision: 1.28 $
-- $Date: 2007/10/12 10:59:14 $
-- Database : PostgreSql
-- Driver   : org.postgresql.Driver
-- Url      : jdbc:postgresql://host:port/database

-- Note: you should use jdbc driver version 7.3 or later
-- You could download latest version here http://jdbc.postgresql.org/download.html
-- Setup unicode with postgreSQL: http://developer.postgresql.org/docs/postgres/multibyte.html

-- Short tutorial (assume the database name is mvnforum) : 
--
-- $ createdb mvnforum
-- $ psql mvnforum
...
-- AUTO_INCREMENT : DEFAULT nextval('table_seq')
-- LONGVARCHAR    : TEXT
-- DATE           : DATE
-- TIMESTAMP      : TIMESTAMP
-- VARCHAR        : VARCHAR
...
-- now()          : now()
--
-- Note : CREATE TABLE / PRIMARY KEY will create implicit index
...
(
   CategoryID                     INT                            NOT NULL DEFAULT nextval('mvnforumCategory_seq'),
...
(
   ForumID                        INT                            NOT NULL DEFAULT nextval('mvnforumForum_seq'),
...
(
   GroupID                        INT                            NOT NULL DEFAULT nextval('mvnforumGroups_seq'),
...
(
   MemberID                       INT                            NOT NULL DEFAULT nextval('mvnforumMember_seq'),
...
(
   PostID                         INT                            NOT NULL DEFAULT nextval('mvnforumPost_seq'),
...
(
   ThreadID                       INT                            NOT NULL DEFAULT nextval('mvnforumThread_seq'),
   ForumID                        INT                            NOT NULL,
   MemberName                     VARCHAR(30)                    NOT NULL,
   LastPostMemberName             VARCHAR(30)                    NOT NULL,
