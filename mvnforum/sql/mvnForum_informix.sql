...
-- $Header: /cvsroot/mvnforum/mvnforum/sql/mvnForum_informix.sql,v 1.4 2007/10/12 11:04:56 minhnn Exp $
-- $Author: minhnn $
-- $Revision: 1.4 $
-- $Date: 2007/10/12 11:04:56 $
...
INSERT INTO mvnforumMemberGroup (GroupID, MemberID, MemberName, Privilege, CreationDate, ModifiedDate)
                         VALUES ('3',     '1',      'admin',    '0',       CURRENT YEAR TO SECOND,        CURRENT YEAR TO SECOND);
