/*
-- $Header: /cvsroot/mvnforum/mvnforum/sql/mvnForum_interbase_unicode_FSS.sql,v 1.24 2008/06/11 08:10:46 lexuanttkhtn Exp $
-- $Author: lexuanttkhtn $
-- $Revision: 1.24 $
-- $Date: 2008/06/11 08:10:46 $
-- Database : Interbase/Firebird (use unicode)
...
(
   ...
   FolderStatus                   INTEGER                        NOT NULL,
   FolderOption                   INTEGER                        NOT NULL,
...
(
   ...
   ThreadAttachCount              INTEGER                        NOT NULL,
