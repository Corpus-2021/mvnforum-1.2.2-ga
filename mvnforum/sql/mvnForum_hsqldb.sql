...
-- $Header: /cvsroot/mvnforum/mvnforum/sql/mvnForum_hsqldb.sql,v 1.21 2007/09/19 03:22:08 minhnn Exp $
-- $Author: minhnn $
-- $Revision: 1.21 $
-- $Date: 2007/09/19 03:22:08 $
...
-- Note: Since 1.7.2, hsqldb support IDENTITY START WITH
-- Note: Download latest hsqldb 1.7.2 at hsqldb.sourceforge.net
...
-- AUTO_INCREMENT : GENERATED BY DEFAULT AS IDENTITY (START WITH 1)
...
(
   CategoryID                     INT                            GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
...
(
   ForumID                        INT                            GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
...
(
   GroupID                        INT                            GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
...
(
   MemberID                       INT                            GENERATED BY DEFAULT AS IDENTITY (START WITH 0), 
...
(
   PostID                         INT                            GENERATED BY DEFAULT AS IDENTITY (START WITH 1), 
...
(
   ThreadID                       INT                            GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
   ForumID                        INT                            NOT NULL,
   MemberName                     VARCHAR(30)                    NOT NULL,
   LastPostMemberName             VARCHAR(30)                    NOT NULL,
...
(
   WatchID                        INT                            GENERATED BY DEFAULT AS IDENTITY (START WITH 1), 
   MemberID                       INT                            NOT NULL,
   CategoryID                     INT                            NOT NULL,
   ForumID                        INT                            NOT NULL,
   ThreadID                       INT                            NOT NULL,
...
(
   RankID                         INT                            GENERATED BY DEFAULT AS IDENTITY (START WITH 1), 
