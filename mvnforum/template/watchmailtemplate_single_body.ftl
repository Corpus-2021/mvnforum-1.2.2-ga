...
Thread Body: ${threadWatch.threadBody}
Last Post Topic: ${threadWatch.lastPostTopic}
Last Post Body: ${threadWatch.lastPostBody}
Last Post URL: ${threadWatch.lastPostUrl}
