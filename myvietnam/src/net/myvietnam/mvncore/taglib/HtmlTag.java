/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/taglib/HtmlTag.java,v 1.6 2007/08/17 04:29:30 hau_mvn Exp $
 * $Author: hau_mvn $
 * $Revision: 1.6 $
 * $Date: 2007/08/17 04:29:30 $
 *
 * ====================================================================
 *
    ...
    public int doStartTag() throws JspTagException {
        try {
            if (isPortletRequest == false) {
                if (locale.equals("ar")) {
                    pageContext.getOut().write("<html rtl>");
                } else if ("true".equals(isHTML)) {
                    pageContext.getOut().write("<html>");   
                } else {
                    pageContext.getOut().write("<html xmlns=\"http://www.w3.org/1999/xhtml\">");
                }
            }
