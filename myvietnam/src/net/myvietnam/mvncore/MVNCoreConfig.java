/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/MVNCoreConfig.java,v 1.41.2.2 2008/11/24 18:50:11 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.41.2.2 $
 * $Date: 2008/11/24 18:50:11 $
 *
 * ====================================================================
 *
...
public class MVNCoreConfig {
    ...
    private static final Log log = LogFactory.getLog(MVNCoreConfig.class);
    ...
    public static void reload() {
        final String classPath = FileUtil.getServletClassesPath();
        final String configFilename = classPath + OPTION_FILE_NAME;
        try {
