/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/db/DBConnectionManager.java,v 1.24 2008/05/30 04:18:36 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.24 $
    ...
    class DBConnectionPool {
        ...
        Connection getConnection(long timeout) {
            ...
            while ((con = getConnection()) == null) {
                ...
                if (timeToWait > TIME_BETWEEN_RETRIES) timeToWait = TIME_BETWEEN_RETRIES;// we don't want to wait for more than TIME_BETWEEN_RETRIES second each time
                try {
