/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/service/impl/MvnCoreInfoServiceImplDefault.java,v 1.41.2.8 2010/08/17 04:38:46 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.41.2.8 $
 * $Date: 2010/08/17 04:38:46 $
 *
 * ====================================================================
 *
...
public class MvnCoreInfoServiceImplDefault implements MvnCoreInfoService {
    ...
    private static String PRODUCT_VERSION      = "2.2.2";
