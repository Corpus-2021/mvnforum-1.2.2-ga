/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/SecondaryMVNCoreConfig.java,v 1.3 2008/05/30 04:18:35 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.3 $
 * $Date: 2008/05/30 04:18:35 $
 *
 * ====================================================================
 *
...
public class SecondaryMVNCoreConfig {
    ...
    private static final Log log = LogFactory.getLog(SecondaryMVNCoreConfig.class);
