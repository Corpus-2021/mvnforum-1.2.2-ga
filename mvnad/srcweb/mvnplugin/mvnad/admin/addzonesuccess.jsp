<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/addzonesuccess.jsp,v 1.2 2008/06/03 16:58:08 minhnn Exp $
 - $Author: minhnn $
 - $Revision: 1.2 $
...
<mvn:html>
<mvn:head>
  <mvn:title><fmt:message key="mvnad.common.ad.title_name"/> - <fmt:message key="mvnad.admin.addzonesuccess.title"/></mvn:title>
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <td width="100%" nowrap="nowrap">
      ...
      <fmt:message key="mvnad.admin.addzonesuccess.title"/>
    </td>
  </tr>
</table>
<br />
