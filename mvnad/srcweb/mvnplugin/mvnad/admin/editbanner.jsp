<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/editbanner.jsp,v 1.9 2008/06/26 03:23:15 lexuanttkhtn Exp $
 - $Author: lexuanttkhtn $
 - $Revision: 1.9 $
 - $Date: 2008/06/26 03:23:15 $
 -
 - ====================================================================
 -
...
<table class="tborder" align="center" cellpadding="3" cellspacing="0" width="95%">
  ...
  <tr class="<mvn:cssrow/>">
    ...
    <td><input type="text" name="MemberName" size="70" value="<%=adBannerBean.getMemberName()%>" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><span class="requiredfield">*</span> <fmt:message key="mvnad.common.banner.name"/></td>
    <td><input type="text" name="BannerName" size="70" value="<%=adBannerBean.getBannerName()%>" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnad.common.banner.description"/></td>
    <td><input type="text" name="BannerDesc" size="70" value="<%=adBannerBean.getBannerDesc()%>" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
  ...
  <tr class="<mvn:cssrow/>" id="BannerHTMLCode"<%if (adBannerBean.getBannerType() != BannerBean.BANNER_TYPE_HTML) {%> style="display:none;"<%}%>>
    ...
    <td valign="top"><textarea cols="70" name="BannerHTMLCode" rows="18"><%=adBannerBean.getBannerHtmlCode()%></textarea></td>
  </tr>
  <tr class="<mvn:cssrow/>" id="BannerTargetURL"<%if (adBannerBean.getBannerType() == BannerBean.BANNER_TYPE_HTML) {%> style="display:none;"<%}%>>
    <td><span class="requiredfield">*</span> <fmt:message key="mvnad.common.banner.target_url"/></td>
    <td><input type="text" name="BannerTargetURL" size="70" value="<%=adBannerBean.getBannerTargetURL()%>" /></td>
  </tr>
  ...
  <tr class="<mvn:cssrow/>">
    ...
    <td><input type="text" name="BannerWidth" size="13" value="<%=adBannerBean.getBannerWidth()%>" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnad.common.banner.height"/></td>
    <td><input type="text" name="BannerHeight" size="13" value="<%=adBannerBean.getBannerHeight()%>" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnad.common.banner.weight"/></td>
    <td><input type="text" name="BannerWeight" size="13" value="1" readonly="readonly" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnad.common.banner.zone_position_x"/></td>
    <td><input type="text" name="BannerZonePositionX" size="13" value="0" readonly="readonly" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnad.common.banner.zone_position_y"/></td>
    <td><input type="text" name="BannerZonePositionY" size="13" value="0" readonly="readonly" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
