<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/uploadmediasuccess.jsp,v 1.3 2008/06/10 11:15:26 lexuanttkhtn Exp $
 - $Author: lexuanttkhtn $
 - $Revision: 1.3 $
 - $Date: 2008/06/10 11:15:26 $
 -
 - ====================================================================
 -
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <a class="nav" href="<%=urlResolver.encodeURL(request, response, "addbanner")%>"><fmt:message key="mvnad.admin.addbanner.title"/></a>&nbsp;&raquo;&nbsp;
    <%} else {%>
    <a class="nav" href="<%=urlResolver.encodeURL(request, response, "managemedia")%>"><fmt:message key="mvnad.admin.managemedia.title"/></a>&nbsp;&raquo;&nbsp;
    <%}%>
