<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/listbanners.jsp,v 1.8 2008/06/13 07:53:10 lexuanttkhtn Exp $
 - $Author: lexuanttkhtn $
 - $Revision: 1.8 $
 - $Date: 2008/06/13 07:53:10 $
 -
 - ====================================================================
 -
...
<table class="tborder" align="center" cellpadding="3" cellspacing="0" width="95%">
  <tr class="pagedesc">
    ...
    <form name="form" action="<%=urlResolver.encodeURL(request, response, "listbanners", URLResolverService.ACTION_URL)%>" <mvn:method/>>
      ...
      <br />
      <fmt:message key="mvnad.common.ad.user"/>
      <select name="MemberName"<%-- onchange="javascript:_gotoPage(this.options[this.selectedIndex].value, <%=zoneID%>)"--%>>
    ...
    <%}%>
      ...
      <br />
      <fmt:message key="mvnad.common.zone"/>
      <select name="ZoneID"<%--  onchange="javascript:_gotoPage('<%=userName%>', this.options[this.selectedIndex].value)"--%>>
    ...
    <%}%>
      ...
      <br />
      <fmt:message key="mvnad.common.sort_by"/>
      <select name="sort">
      ...
      <fmt:message key="mvnad.common.order"/>
      <select name="order">
...
<%}
  ...
  <tr class="<mvn:cssrow/>">
    <td colspan="18" align="center"><fmt:message key="mvnad.admin.listbanners.no_banner_here" /></td>
  </tr>
<%}%>
</mvn:cssrows>
</table>
