<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/uploadmedia.jsp,v 1.2 2008/06/24 18:34:34 minhnn Exp $
 - $Author: minhnn $
 - $Revision: 1.2 $
 - $Date: 2008/06/24 18:34:34 $
 -
 - ====================================================================
 -
...
<form id="uploadmedia" name="uploadmedia" action="<%=urlResolver.encodeURL(request, response, "uploadmediaprocess", URLResolverService.ACTION_URL)%>" method="post" enctype="multipart/form-data">
