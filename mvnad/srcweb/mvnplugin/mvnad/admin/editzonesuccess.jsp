<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/editzonesuccess.jsp,v 1.2 2008/06/03 16:58:12 minhnn Exp $
 - $Author: minhnn $
 - $Revision: 1.2 $
 - $Date: 2008/06/03 16:58:12 $
 -
 - ====================================================================
 -
...
<mvn:html>
<mvn:head>
  <mvn:title><fmt:message key="mvnad.common.ad.title_name"/> - <fmt:message key="mvnad.admin.editzonesuccess.title"/></mvn:title>
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <td width="100%" nowrap="nowrap">
      ...
      <fmt:message key="mvnad.admin.editzonesuccess.info"/>
    </td>
  </tr>
</table>
<br />
