<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/index.jsp,v 1.3 2008/06/13 10:37:49 lexuanttkhtn Exp $
 - $Author: lexuanttkhtn $
 - $Revision: 1.3 $
 - $Date: 2008/06/13 10:37:49 $
 -
 - ====================================================================
 -
...
<table width="95%" align="center">
  <tr class="command">
    ...
    <td width="100%" nowrap="nowrap">
      <a class="nav" href="index"><fmt:message key="mvnad.admin.index.title"/></a>
    </td>
  </tr>
</table>
<br />
