<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/editbannerofzonesuccess.jsp,v 1.2 2008/06/03 16:58:11 minhnn Exp $
 - $Author: minhnn $
 - $Revision: 1.2 $
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <td width="100%" nowrap="nowrap">
      ...
      <fmt:message key="mvnad.admin.editzonebannersuccess.info"/>
    </td>
  </tr>
</table>
<br />
