<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/error.jsp,v 1.3 2008/06/03 16:58:12 minhnn Exp $
 - $Author: minhnn $
 - $Revision: 1.3 $
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <td width="100%" nowrap="nowrap">
      <a class="nav" href="index"><fmt:message key="mvnad.admin.index.title"/></a>&nbsp;&raquo;&nbsp;
