<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/header.jsp,v 1.5 2008/06/11 11:12:41 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.5 $
 - $Date: 2008/06/11 11:12:41 $
 -
 - ====================================================================
 -
...
<%}%>
<%if (permission.canViewZone() && (environmentService.getAdRunMode() == EnvironmentService.PRODUCT_ENTERPRISE)) {%>
