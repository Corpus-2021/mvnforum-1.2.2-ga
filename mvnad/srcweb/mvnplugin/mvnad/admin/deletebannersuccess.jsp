<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/deletebannersuccess.jsp,v 1.2 2008/06/03 16:58:09 minhnn Exp $
 - $Author: minhnn $
 - $Revision: 1.2 $
...
<mvn:html>
<mvn:head>
  <mvn:title><fmt:message key="mvnad.common.ad.title_name"/> - <fmt:message key="mvnad.admin.deletebannersuccess.title"/></mvn:title>
<%@ include file="/mvnplugin/mvnad/meta.jsp"%>
<meta http-equiv="refresh" content="3; url=<%=urlResolver.encodeURL(request, response, "listbanners")%>"/>
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <td width="100%" nowrap="nowrap">
      ...
      <fmt:message key="mvnad.admin.deletebannersuccess.info"/>
    </td>
  </tr>
</table>
<br />
...
<table class="tborder" width="95%" cellspacing="1" cellpadding="3" align="center">
  ...
  <tr class="<mvn:cssrow/>">
    <td><b>&raquo;</b>&nbsp;<a class="command" href="<%=urlResolver.encodeURL(request, response, "listbanners")%>"><fmt:message key="mvnad.admin.success.return_to_banner_management"/></a> (<fmt:message key="mvnad.common.success.automatic"/>)</td>
  </tr>
  <tr class="<mvn:cssrow/>">
