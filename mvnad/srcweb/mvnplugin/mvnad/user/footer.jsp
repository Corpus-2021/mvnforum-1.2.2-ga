<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/user/footer.jsp,v 1.4.2.1 2010/08/18 04:32:32 minhnn Exp $
 - $Author: minhnn $
 - $Revision: 1.4.2.1 $
 - $Date: 2010/08/18 04:32:32 $
 -
 - ====================================================================
 -
...
<table width="95%" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td align="right" class="pageFooter">
      <fmt:message key="mvnad.common.footer.timezone"/> <%=onlineUser.getTimeZoneFormat()%><br/>    
...
<div align="center" class="pageFooter">
  ...
  NOTE: In case you need to remove this "Powered by mvnAd", please contact us at 
