...
-- $Header: /cvsroot/mvnforum/mvnad/sql/mvnad_SAPDB.sql,v 1.3 2008/05/16 08:09:53 minhnn Exp $
-- $Author: minhnn $
-- $Revision: 1.3 $
-- $Date: 2008/05/16 08:09:53 $
...
(
    BannerID                        INT DEFAULT SERIAL      NOT NULL,
    ...
    CONSTRAINT constraint_banner_name_name UNIQUE (MemberName, BannerName)
);

CREATE TABLE mvnadZone 
(
    ZoneID                          INT DEFAULT SERIAL      NOT NULL AUTO_INCREMENT,
    MemberName                      VARCHAR(30)             NOT NULL,
    ...
    PRIMARY KEY (ZoneID),
    CONSTRAINT constraint_banner_name UNIQUE (MemberName, ZoneName)
);
