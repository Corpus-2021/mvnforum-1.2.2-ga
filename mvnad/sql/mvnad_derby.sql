...
-- $Header: /cvsroot/mvnforum/mvnad/sql/mvnad_derby.sql,v 1.3 2008/05/16 08:09:54 minhnn Exp $
-- $Author: minhnn $
-- $Revision: 1.3 $
...
(
    BannerID                        INT             NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    ...
    BannerHtmlCode                  LONG VARCHAR    NOT NULL,
...
(
    ZoneID                          INT             NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    MemberName                      VARCHAR(30)     NOT NULL,
