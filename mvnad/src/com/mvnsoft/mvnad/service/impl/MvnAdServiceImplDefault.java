/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/service/impl/MvnAdServiceImplDefault.java,v 1.2 2008/06/03 08:20:53 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.2 $
...
public class MvnAdServiceImplDefault implements MvnAdService {
    ...
    public ExternalBannerService getExternalBannerService() {
    ...
    public MvnAdInfoService getMvnAdInfoService() {
    ...
    public MvnAdModuleProcessorService getMvnAdModuleProcessorService() {
    ...
    public MvnAdLifeCycleService getMvnAdLifeCycleService() {
    ...
    public MvnAdTrackerService getMvnAdTrackerService() {
