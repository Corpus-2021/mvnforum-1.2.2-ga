/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/MVNAdConfig.java,v 1.5 2008/06/17 04:51:36 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.5 $
...
public final class MVNAdConfig {
    ...
    private static final Log log = LogFactory.getLog(MVNAdConfig.class);
    ...
    private static void setMVNAdHome(String home) {
        ...
        try {
            ...
            log.fatal("Cannot setup the mvnAdHome folder. Please correct it first.", ex);
            MvnCoreServiceFactory.getMvnCoreService().getEnvironmentService().setShouldRun(false, "Check your mvnAdHome. Detail : " + ex.getMessage());
