/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/db/jdbc/ZoneBannerDAOImplJDBC.java,v 1.3 2008/06/03 08:20:50 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.3 $
 * $Date: 2008/06/03 08:20:50 $
 *
 * ====================================================================
 *
...
public class ZoneBannerDAOImplJDBC implements ZoneBannerDAO {
    ...
    private static final Log log = LogFactory.getLog(ZoneBannerDAOImplJDBC.class);
