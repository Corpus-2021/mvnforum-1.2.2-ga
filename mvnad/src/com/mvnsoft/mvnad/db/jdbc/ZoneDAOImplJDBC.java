/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/db/jdbc/ZoneDAOImplJDBC.java,v 1.6 2008/06/10 09:35:48 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.6 $
 * $Date: 2008/06/10 09:35:48 $
 *
 * ====================================================================
 *
...
public class ZoneDAOImplJDBC implements ZoneDAO {
    ...
    private static final Log log = LogFactory.getLog(ZoneDAOImplJDBC.class);
