/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/db/jdbc/BannerDAOImplJDBC.java,v 1.8 2008/06/11 11:37:31 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.8 $
 * $Date: 2008/06/11 11:37:31 $
 *
 * ====================================================================
 *
...
public class BannerDAOImplJDBC implements BannerDAO {
    ...
    private static final Log log = LogFactory.getLog(BannerDAOImplJDBC.class);
