/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/db/BannerBean.java,v 1.2 2008/06/03 08:20:49 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.2 $
...
public class BannerBean {
    ...
    public final static int BANNER_TYPE_IMAGE = 0;
    public final static int BANNER_TYPE_FLASH = 1;
    public final static int BANNER_TYPE_MOVIE = 2;
    public final static int BANNER_TYPE_HTML  = 3;
    
    public final static int BANNER_IS_HTML    = 1;
