/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/delivery/ZoneManager.java,v 1.5 2008/06/03 08:20:51 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.5 $
...
public final class ZoneManager {
    ...
    public String getBannerInZone() 
        ...
        return getBannerInZone(null);
    }

    public String getBannerInZone(Timestamp timestamp) 
        throws DatabaseException, CreateException, DuplicateKeyException, ForeignKeyNotFoundException, ObjectNotFoundException {
        ...
        String bannerURL = ParamUtil.getServerPath() + ParamUtil.getContextPath() + DeliveryModuleConfig.getUrlPattern() + "/clickad?bannerID=" + currentBanner.getBannerID() + "&zoneID=" + zoneBean.getZoneID();
        ...
        if (timestamp == null) {
            ...
            result.append("<a id='").append(AdModuleUtils.getDocumentID(zoneBean.getZoneID(), timestamp)).append("' href='");
        }
        result.append(bannerURL);
        result.append("' target='" + zoneBean.getZoneTargetWindow() + "'>");
