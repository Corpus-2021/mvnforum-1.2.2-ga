/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/delivery/DeliveryProcessor.java,v 1.6 2008/06/05 11:08:48 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.6 $
 * $Date: 2008/06/05 11:08:48 $
 *
 * ====================================================================
 *
...
public class DeliveryProcessor implements MvnAdModuleProcessor {
    ...
    private static final Log        log             = LogFactory.getLog(DeliveryProcessor.class);
    ...
    public String process(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (throwable instanceof BadInputException) {
                ...
                log.fatal("Exception in DeliveryProcessor: " + throwable.getMessage(), throwable);
            } else {
