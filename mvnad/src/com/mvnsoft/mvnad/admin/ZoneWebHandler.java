/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/admin/ZoneWebHandler.java,v 1.7 2008/06/25 10:47:13 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.7 $
 * $Date: 2008/06/25 10:47:13 $
 *
 * ====================================================================
 *
...
public class ZoneWebHandler {
    ...
    private static final Log log = LogFactory.getLog(ZoneWebHandler.class);
