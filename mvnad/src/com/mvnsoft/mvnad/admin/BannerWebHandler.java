/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/admin/BannerWebHandler.java,v 1.15 2008/06/25 10:47:14 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.15 $
 * $Date: 2008/06/25 10:47:14 $
 *
 * ====================================================================
 *
...
public class BannerWebHandler {
    ...
    private static final Log log = LogFactory.getLog(BannerWebHandler.class);
...
//        }
        ...
        request.setAttribute("ZoneBeans", DAOFactoryAd.getZoneDAO().getBeans());
        request.setAttribute("MemberBeans", DAOFactoryAd.getBannerDAO().getDistinctMemberNamesHasBanner());
