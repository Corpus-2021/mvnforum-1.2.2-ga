/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/admin/AdAdminWebHandler.java,v 1.4.2.2 2008/11/19 06:57:42 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.4.2.2 $
 * $Date: 2008/11/19 06:57:42 $
 *
 * ====================================================================
 *
...
public class AdAdminWebHandler {
    ...
    private static final Log log = LogFactory.getLog(AdAdminWebHandler.class);
    ...
    public void processAddZoneBanner(GenericRequest request)
        ...
        Timestamp relationPublishStartDate  = new Timestamp(startDate.getTime());
        Timestamp relationPublishEndDate    = new Timestamp(endDate.getTime());
