/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/admin/AdAdminModuleProcessor.java,v 1.7 2008/06/26 04:18:04 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.7 $
 * $Date: 2008/06/26 04:18:04 $
 *
 * ====================================================================
 *
...
public class AdAdminModuleProcessor implements MvnAdModuleProcessor {
    ...
    private static final Log           log                = LogFactory.getLog(AdAdminModuleProcessor.class);
    ...
    public String process(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (requestURI.equals("/index")) {
                adAdminWebHandler.ensureAdminPermission(genericRequest);
            ...
            if (e instanceof BadInputException) {
                ...
                log.fatal("Exception in AdAdminModuleProcessor e = " + e.getMessage(), e);
            } else {
