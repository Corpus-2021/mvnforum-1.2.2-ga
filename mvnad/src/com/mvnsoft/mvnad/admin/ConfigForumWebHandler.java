/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/admin/ConfigForumWebHandler.java,v 1.3 2008/06/03 08:20:49 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.3 $
...
public class ConfigForumWebHandler {
    ...
    private static final Log log = LogFactory.getLog(ConfigForumWebHandler.class);
    ...
    public void process(GenericRequest request) 
        ...
        log.debug("-----------------------------ConfigForumWebHandler.process()------------------------------");
